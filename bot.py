...
async def start(event):
  await event.reply("**boss_tag_bot Bot**, Grup veya kanaldaki neredeyse tüm üyelerden bahsedebilirim ★\nDaha fazla bilgi için **/help**'i tıklayın.",
                    buttons=(
                      [Button.url('🌟 Beni Bir Gruba Ekle', 'https://t.me/boss_tag_bot?startgroup=a'),
                      Button.url('📣 Kanalım', 'https://t.me/videomahni'),
